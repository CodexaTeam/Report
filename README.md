...
**Facultad de Ingeniería de Software** <br>
**Ciclo 2025-20** <br>
...
u20201b914 - Huanca Zevallos, Cristhian Joel<br>
u202311086 - Landa Ortiz, Sergio Javier<br>
u202014249 - Sagastegui Rodriguez, Luis Jesus<br>
u202314354 - Solis Campos, Estefano Sebastian<br>
  ...
  <tr>
    ...
    <td>
      ...
      explicación del modelo de base de datos y sus relaciones; sustentación de las guías de estilo en el equipo.
        ...
        <br> - TF: Organicé la distribución de tareas mediante reuniones para informar a todos los miembros del equipo sobre las responsabilidades finales del proyecto. <br><br>
      <b>Sagastegui Rodriguez, Luis Jesus</b> <br> - TB1: Realización y búsqueda de competidores. Presentación de los MockUps y Wireframes de la landing page, codificación parcial de la landing page e identificación de User Stories. <br> - TP: Me comuniqué de manera efectiva mis avances del proyecto con mis compañeros de grupo, siempre haciéndoles saber mis dificultades ante cualquier duda o contratiempo. <br> - TB2: Comunicación grupal y dar ideas respecto a los User Stories trazados para el backend. <br> - TF: Presenté y coordiné oralmente los apartados de las Validation Interviews (diseño, registro y análisis de entrevistas de validación), explicando los resultados obtenidos y las evaluaciones según heurísticas. <br><br>
      <b>Solis Campos, Estefano Sebastian</b> <br> - TB1: Exposición y sustentación del Capítulo 4, explicando verbalmente el marco metodológico y la arquitectura de software propuesta al equipo. <br> - TP1: Presentación al equipo de la arquitectura base del frontend, detallando la estructura de componentes y el sistema de navegación. <br> - TB2: Coordinación y sustentación oral de la implementación del módulo de autenticación (IAM) y la estrategia de integración (merge) del backend. <br> - TF: Coordiné junto con Sergio Landa las verificaciones finales del informe del report, asegurando la coherencia y calidad del documento antes de la entrega final. <br><br>
      <b>Sergio Javier Landa Ortiz</b> <br> - TB1: Exposición y sustentación del Capítulo 3 (Definición del Producto), explicando verbalmente las técnicas de análisis de requisitos, como User Personas e Impact Mapping. <br> - TP1: Presentación al equipo de la arquitectura base del backend, detallando el diseño de la API REST y la configuración inicial de la base de datos. <br> - TB2: Presentación y coordinación de los avances del módulo de reservas (Booking) y colaboración en la unificación del código (merge) con el equipo. <br> - TF: Coordiné junto con Estefano Solis las verificaciones finales del informe del report, validando que todos los apartados estuvieran correctamente redactados y estructurados para la entrega final.
    </td>
  ...
  <tr>
    ...
    <td>
      ...
      guías de estilo; desarrollo del diagrama de base de datos; redacción de las conclusiones del informe.
        ...
        <br> - TB2: Organicé mediante el trello y mensajes por escrito sobre mi avance en el BC listing.
        <br> - TF: Actualicé los links del Anexo y del project report collaboration, actualizacé los insights de cada entrega, redacté las recomendaciones para futuras mejoras, redacté la sección Video About-the-Team, elaboré el documento de colaboración del equipo, y actualicé el registro de versiones del informe con la entrega final. <br><br>
      <b>Sagastegui Rodriguez, Luis Jesus</b> <br> - TB1: Desarrollo parcial del frontend con el capitulo 5, teniendo en cuenta la metodologia previamente aprendida <br> - TP1: Codificacion parcial del frontend, documentando debidamente cada avance realizado en el Sprint <br> - TB2: Desarrollo parcial de endpoints con su documentacion en el Sprint, considerando los User Stories previamente trazados. <br> - TF: Redacté la sección 5.3. Validation Interviews incluyendo el diseño de entrevistas (5.3.1), el registro de entrevistas de validación (5.3.2) y las evaluaciones según heurísticas (5.3.3), documentando los resultados obtenidos de la validación del producto con usuarios finales. <br><br>
      ...
      <br> - TB2: Implementación y documentación del módulo de autenticación (IAM). Gestión del merge de las ramas del backend y aporte en la redacción del informe. <br> - TF: Coordié con Sergio Landa las verificaciones finales del reporte, validando la estructura, redacción y coherencia del documento completo. Participé en la documentación de la integración backend-frontend y en la resolución de issues técnicos en el desarrollo. <br><br>
      <b>Sergio Javier Landa Ortiz</b> <br> - TB1: Redacción y desarrollo del Capítulo 3 (Definición del Producto), documentando por escrito los perfiles de usuario y las especificaciones de requisitos. <br> - TP1: Codificación e implementación de la estructura inicial del backend (API REST), documentando la configuración del proyecto y los endpoints base. <br> - TB2: Desarrollo e implementación del módulo de reservas (Booking). Colaboración en la gestión de commits para el merge del backend y aporte en la redacción del informe. <br> - TF: Redacté la sección 5.3. Validation Interviews con el diseño, registro y análisis de entrevistas de validación, documentando las evaluaciones según heurísticas del producto final. Coordiné con Estefano Solis las verificaciones del reporte, asegurando que todos los apartados cumplieran con los estándares de calidad requeridos.
    </td>
...
#### **URL del Video:**
- [**Microsoft Stream URL**](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202014249_upc_edu_pe/IQBRQ-w4m-uiTZx0HkCpkrYoAdP0kKPshjPTmEVJ_LQJb_E)
- [**YouTube URL**](https://youtu.be/mm6XtLGodz8)
...
<img src="./assets/sprint4/about-the-team.jpeg" alt="Equipo de trabajo" width="600">

#### **URL del Video:**
- [**Microsoft Stream URL**](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202014249_upc_edu_pe/IQAUoEjJ2x54TLJOZH6-3gjSAbomfJIY7JUJMbCX6-vItGQ?e=4uw4ff&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D)
- [**YouTube URL**](https://youtu.be/S1iQyE4EdRo)
